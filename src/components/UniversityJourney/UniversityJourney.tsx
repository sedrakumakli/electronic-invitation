        ...
        <div className='grid lg:grid-cols-2 gap-12 items-center'>
          ...
          >
            ...
            >
              ...
              الحمدلله على هذه الرحلة بكل ما حملته من دروس وتجارب، وعلى كل شخص
              كان جزءًا منها. واليوم، وأنا أصل إلى نهاية هذه المرحلة، أحمل معي
              الكثير من المعرفة والذكريات والامتنان، وأتطلع لما تحمله الخطوات
              القادمة من فرص وتجارب جديدة.
            </motion.p>
